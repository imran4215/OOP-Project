...
async function scrapeUltraTech(query) {
  const url = `https://www.ultratech.com.bd/index.php?route=product/search&search=${query}`;
  ...
  try {
    ...
    console.error(`Error scraping UltraTech: ${error.message}`);
    return [];
  }
}

export { scrapeUltraTech };
